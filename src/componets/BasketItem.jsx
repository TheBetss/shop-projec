export default function BaksetItem(props) {
  const { id, name, price, quantity, incrementQuantity, dncrementQuantity } =
    props;
  ...
  return (
    <li className="collection-item">
      ...
      <span className="secondary-content">
        ...
        <a className="waves-effect waves-light btn btnq" onClick={() => dncrementQuantity(id)}
